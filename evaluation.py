...
class MLPLayer(nn.Module):
    ...
    def __init__(self, proj_output_dim):
        super().__init__()
        sizes = [768] + list(map(int, proj_output_dim.split('-')))
        layers = []
...
def main():
    ...
    mlp = MLPLayer(args.proj_output_dim[0])
